...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 12, 0, 254);
    			attr_dev(input1, "type", "text");
    			add_location(input1, file, 13, 0, 333);
    			attr_dev(div, "class", "preview svelte-4qbdzo");
    			attr_dev(div, "style", div_style_value = `background-color: ${/*fullColour*/ ctx[3]};`);
    			add_location(div, file, 14, 0, 413);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*hex*/ ctx[1]);
    			insert_dev(target, t0, anchor);
    			insert_dev(target, input1, anchor);
    			set_input_value(input1, /*alpha*/ ctx[2]);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*alpha*/ 4 && input1.value !== /*alpha*/ ctx[2]) {
    				set_input_value(input1, /*alpha*/ ctx[2]);
    			}

    			if (dirty & /*fullColour*/ 8 && div_style_value !== (div_style_value = `background-color: ${/*fullColour*/ ctx[3]};`)) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("onUpdate" in $$props) $$invalidate(0, onUpdate = $$props.onUpdate);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("fullColour" in $$props) $$invalidate(3, fullColour = $$props.fullColour);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*hex, alpha*/ 6) {
    			 $$invalidate(3, fullColour = hex + alpha);
    		}
    	};
    ...
    class ColourPicker extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { onUpdate: 0 });
    		...
    		if (/*onUpdate*/ ctx[0] === undefined && !("onUpdate" in props)) {
    ...
    function create_fragment$1(ctx) {
    	...
    	colourpicker0 = new ColourPicker({
    			props: { onUpdate: /*func*/ ctx[4] },
    			$$inline: true
    		});

    	colourpicker1 = new ColourPicker({
    			props: { onUpdate: /*func_1*/ ctx[5] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-opi4hh");
    			add_location(input, file$1, 64, 7, 2190);
    			attr_dev(div0, "class", "svelte-opi4hh");
    			add_location(div0, file$1, 64, 2, 2185);
    			attr_dev(button, "class", "svelte-opi4hh");
    			add_location(button, file$1, 67, 2, 2331);
    			if (img.src !== (img_src_value = /*preview*/ ctx[1])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Preview");
    			attr_dev(img, "class", "svelte-opi4hh");
    			add_location(img, file$1, 68, 7, 2387);
    			attr_dev(div1, "class", "svelte-opi4hh");
    			add_location(div1, file$1, 68, 2, 2382);
    			attr_dev(main, "class", "svelte-opi4hh");
    			add_location(main, file$1, 63, 0, 2176);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t0);
    			mount_component(colourpicker0, main, null);
    			append_dev(main, t1);
    			mount_component(colourpicker1, main, null);
    			append_dev(main, t2);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, colour1, $$value => $$invalidate(6, $colour1 = $$value));
    	validate_store(colour2, "colour2");
    	component_subscribe($$self, colour2, $$value => $$invalidate(7, $colour2 = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	return [files, preview, chromaKey, input_change_handler, func, func_1];
    }
